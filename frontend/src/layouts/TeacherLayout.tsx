...
const TeacherLayout: React.FC = () => {
  ...
  const menuItems = [
    { text: 'Instructor Home', icon: <LayoutDashboard size={20} />, path: '/teacher/dashboard' },
    { text: 'My Courses', icon: <BookType size={20} />, path: '/teacher/courses' },
    { text: 'Student Lists', icon: <Users size={20} />, path: '/teacher/students' },
    { text: 'Course Insights', icon: <BarChart3 size={20} />, path: '/teacher/analytics' },
  ];
  ...
  const drawer = (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <Box sx={{ p: 2, display: 'flex', alignItems: 'center', gap: 1.5, minHeight: 64 }}>
        <Box sx={{ p: 1, bgcolor: 'secondary.main', borderRadius: 1.5, color: '#fff' }}>
      ...
      >
        <Toolbar sx={{ justifyContent: 'space-between' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            >
              <MenuItem onClick={handleMenuClose}>Instructor Profile</MenuItem>
              <MenuItem onClick={() => { navigate('/teacher/dashboard'); handleMenuClose(); }}>Dashboard</MenuItem>
              <Divider />
